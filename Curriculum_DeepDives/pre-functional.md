...
### Practical Examples
1. **Map (Transformation):** Applying a function to every row in a massive dataset simultaneously without side effects.
2. **Filter (Transformation):** Removing corrupted JSON lines from a dataset. Spark records this intent but waits to execute it.
...
> [!TIP]
> **Library References:**
> *   *Beginning Apache Spark 2* (Immutability) — Pages 5, 18, 32
> *   *Spark in Action* — Pages 32, 35
