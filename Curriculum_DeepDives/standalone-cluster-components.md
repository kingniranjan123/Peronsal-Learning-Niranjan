...
<🔥 Master Class: Standalone Cluster Components> [Ref: 451](spark_book.pdf#page=451)
## Overview
...
- **CoarseGrainedExecutorBackend:** The physical JVM container where the actual distributed data processing occurs. It registers directly with the Driver upon booting, houses the `BlockManager` for distributed caching, and executes the Tungsten whole-stage code-generated tasks. [Ref: 457](spark_book.pdf#page=457)

--- [Ref: 463](spark_book.pdf#page=463)

## ⚠️ Critical Concepts & Common Pitfalls [Ref: 470](spark_book.pdf#page=470)
